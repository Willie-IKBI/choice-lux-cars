-- Final Driver Flow Fix
-- Applied: 2025-08-14
-- Description: Adds missing driver_user column and fixes start_job function
...
-- 2. Drop and recreate the start_job function with proper column reference
...
-- 5. Show the final driver_flow table structure
SELECT 
    column_name, 
    data_type, 
    is_nullable, 
