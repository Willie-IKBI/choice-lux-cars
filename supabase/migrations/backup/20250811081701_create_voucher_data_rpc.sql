-- Create RPC function to fetch voucher data for PDF generation
-- This function returns all necessary data for generating a voucher PDF
...
COMMENT ON FUNCTION get_voucher_data_for_pdf(int) IS 'Fetches complete voucher data for PDF generation including job details, client info, agent details, passenger info, driver/vehicle info, and transport details';
