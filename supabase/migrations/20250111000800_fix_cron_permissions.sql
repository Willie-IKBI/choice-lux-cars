...
DO $grant$
BEGIN
  EXECUTE 'GRANT SELECT ON TABLE net.http_response_queue TO postgres';
EXCEPTION
  WHEN undefined_table THEN
    RAISE NOTICE 'net.http_response_queue missing; skipping postgres grant';
END;
$grant$;
...
DO $grant$
BEGIN
  EXECUTE 'GRANT SELECT ON TABLE net.http_response_queue TO authenticated';
EXCEPTION
  WHEN undefined_table THEN
    RAISE NOTICE 'net.http_response_queue missing; skipping authenticated grant';
END;
$grant$;
