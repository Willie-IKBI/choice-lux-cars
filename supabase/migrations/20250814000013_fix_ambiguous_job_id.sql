-- Fix Ambiguous job_id Reference
-- Applied: 2025-08-14
-- Description: Fix ambiguous job_id reference in start_job function

-- Drop and recreate the start_job function with explicit column references
