...
GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE net.http_request_queue TO postgres;
GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE net.http_request_queue TO service_role;

-- ============================================
-- Step 3: If above doesn't work, try ALTER DEFAULT PRIVILEGES
-- ============================================
-- This sets default privileges for future objects created by supabase_admin
-- Note: This won't affect existing objects, but might help
