-- Force fix voucher RPC functions by dropping and recreating them
...
-- Now recreate the main voucher data function with the correct syntax
...
BEGIN
    ...
    -- Get transport details for the job - FIXED SYNTAX
    SELECT json_agg(
        json_build_object(
...
-- Now recreate the convenience function
