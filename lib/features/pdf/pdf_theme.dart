...
class PdfTheme {
  ...
  static pw.TextStyle get titleLarge => pw.TextStyle(
    font: fontBold,
    fontSize: 28,
    color: grey800,
  );
  ...
  static pw.TextStyle get titleMedium => pw.TextStyle(
    font: fontBold,
    fontSize: 20,
    color: grey800,
  );
  ...
  static pw.TextStyle get titleSmall => pw.TextStyle(
    font: fontBold,
    fontSize: 16,
    color: grey800,
  );
  ...
  static pw.TextStyle get bodyText => pw.TextStyle(
    font: fontRegular,
    fontSize: 12,
    color: grey700,
  );
  ...
  static pw.TextStyle get captionText => pw.TextStyle(
    font: fontRegular,
    fontSize: 10,
    color: grey600,
  );
      ...
      children: [
        ...
        pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              _buildContactRow(['Email: bookings@choiceluxcars.com', 'Phone: +27 74 239 2222']),
              pw.SizedBox(height: spacing4),
              _buildContactRow(['Web: www.choiceluxcars.com', 'Address: 25 Johnson Road, Bedfordview, Johannesburg']),
            ],
          ),
        ),
  ...
  static pw.Widget buildFooter(String contactInfo) {
    return pw.Container(
      ...
      decoration: const pw.BoxDecoration(
        border: pw.Border(
          top: pw.BorderSide(color: grey300, width: 1),
        ),
      ),
      child: pw.Text(
        contactInfo,
  ...
  static pw.Widget buildSectionHeader(String title) {
    return pw.Container(
      padding: const pw.EdgeInsets.symmetric(vertical: spacing12, horizontal: spacing16),
      decoration: pw.BoxDecoration(
        color: gold50,
      ...
      child: pw.Text(
        title,
        style: titleMedium.copyWith(color: gold700),
      ),
    );
  }
