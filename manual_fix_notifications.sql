...
-- 3. Create a new function that directly creates notifications
...
-- 4. Create trigger for job assignment (both INSERT and UPDATE)
...
-- 5. Process existing pending notifications manually
INSERT INTO notifications (
  user_id,
  job_id,
  body,
...
-- 6. Mark the processed notifications as processed
